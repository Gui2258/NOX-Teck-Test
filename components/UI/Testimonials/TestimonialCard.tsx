...
export const TestimonialCard: React.FC<TestimonilaCardProps> = ({ data }) => {
    return (
        <div className="shadow-[0px 0px 6px 0px #00000012] flex flex-col items-center gap-[16px] bg-white px-[16px] py-[24px] md:max-w-[758px] relative transition-all duration-300 ease-in-out transform hover:scale-[1.02]">
