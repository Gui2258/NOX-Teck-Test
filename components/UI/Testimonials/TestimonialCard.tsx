...
export const TestimonialCard: React.FC<TestimonilaCardProps> = ({ data }) => {
    return (
        <div className="flex flex-col items-center gap-[16px] md:gap-[24px] shadow-[0px_0px_6px_0px_rgba(0,0,0,0.07),0px_10px_15px_-3px_rgba(0,0,0,0.1)] bg-white px-[16px] py-[24px] md:max-w-[758px] hover:scale-[1.02]">
